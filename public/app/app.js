...
app.factory('MyProduct', function($resource) {
  return $resource('/api/myProducts/:id', { id: '@_id' }, {
...
/*app.factory('MyPatient', function($resource) {
    return $resource('/api/mypatients/:id', { id: '@_id' }, {
        update: { // We need to define this method manually as it is not provided with ng-resource
            method: 'PUT'
        }
    });
